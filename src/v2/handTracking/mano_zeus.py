...
class MiniInterfaz:
    def __init__(self, root):
        self.root = root
        self.root.title("Mini Interfaz con Imágenes y Botones")
        ...
        self.l_2 = tk.Label(root, text = "MODE" + str(mode+1))
